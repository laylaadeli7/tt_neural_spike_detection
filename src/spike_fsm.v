...
// DETECT:      Threshold exceeded - emit spike pulse for 1 cycle,
//              latch timestamp
...
module spike_fsm (
    ...
    reg [1:0]  state;
    reg [7:0]  refrac_cnt; // refractory counter
    reg [6:0]  timestamp;  // 7-bit rolling timestamp
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            case (state)
                ...
                DETECT: begin
                    // want to emit spike pulse in this cycle with timestamp
